...
<svelte:head>
	<title>Sveltekit Recipe App</title>
	...
	<svelte:fragment slot="header">
		<AppBar gridColumns="grid-cols-3" slotDefault="place-self-center" slotTrail="place-content-end">
			<svelte:fragment slot="lead">
				<a href="/" class="h2 hover:text-primary-500 font-medium">
					<i class="fa-solid fa-house text-4xl"></i>
				</a>
			</svelte:fragment>
			<h1 class="text-4xl">Recipe App</h1>
			<svelte:fragment slot="trail">
				<a href="/add" class="btn variant-filled hover:bg-primary-500 hover:text-white"
					>Add Recipe</a
				>
			</svelte:fragment>
		</AppBar>
