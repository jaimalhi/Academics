import { c as create_ssr_component, a as subscribe, v as validate_component, s as setContext, e as escape, b as add_attribute, d as add_styles, f as createEventDispatcher, g as spread, h as escape_object, m as missing_component, i as each, j as getContext, k as compute_slots } from './ssr-V-Hd1H2_.js';
import { i as initializeToastStore, p as prefersReducedMotionStore, g as getToastStore } from './ProgressBar.svelte_svelte_type_style_lang--QH1TJfj.js';
import { i as initializeModalStore, g as getModalStore } from './stores-q9pBl3pJ.js';
import { w as writable } from './exports-oiHf4OuW.js';
import { f as fly } from './index2-Jzlktigj.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-z6voyx_START -->${$$result.title = `<title>Recipe Safe</title>`, ""}<meta name="description" content="Simple recipe app created with sveltekit & skeleton"><!-- HEAD_svelte-z6voyx_END -->`, ""} ${validate_component(Toast, "Toast").$$render($$result, { position: "br" }, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    footer: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render(
        ...
        {
          trail: () => {
            return `<a class="anchor" href="https://github.com/jaimalhi/Academics/tree/main/CMPT372/A2-RecipeUpgraded" data-svelte-h="svelte-2wz3y2">GitHub</a> `;
          },
          lead: () => {
            return `<div data-svelte-h="svelte-1yxb57p"><a class="anchor" href="https://kit.svelte.dev/">Sveltekit</a>
					+
					<a class="anchor" href="https://www.skeleton.dev/">Skeleton</a></div>`;
          }
        }
      )} `;
    },
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render(
        ...
        {
          trail: () => {
            return `<button ${addRecipeBtn ? "disabled" : ""} class="btn variant-filled hover:bg-primary-500 hover:text-white">Add Recipe</button> `;
          },
          lead: () => {
            return `<a href="/recipes" class="h2 hover:text-primary-500 font-medium" data-svelte-h="svelte-6tlg9i"><i class="fa-solid fa-house text-4xl"></i></a> `;
          },
          default: () => {
            return `<h1 class="text-4xl text-center" data-svelte-h="svelte-rnd7tj">Recipe Safe</h1>`;
          }
        }
      )} `;
    },
    default: () => {
      return ` <div class="p-7 mx-auto">${slots.default ? slots.default({}) : ``}</div> `;
    }
  })}`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-D9CwU6jm.js.map
