...
void* ThreadHandler_producer(void* threadarg) {
...
void* ThreadHandler_sender(void* threadarg) {
    ListShare* threadArguments = (ListShare*)threadarg;
    List* sendQueue = threadArguments->sharedList;
    char* message;
...
void* ThreadHandler_receiver(void* threadarg) {
    ListShare* threadArguments = (ListShare*)threadarg;
...
// displays messages
void* ThreadHandler_consumer(void* threadarg) {
    ListShare* threadArguments = (ListShare*)threadarg;
    List* receiveQueue = threadArguments->sharedList;
    char* message;
